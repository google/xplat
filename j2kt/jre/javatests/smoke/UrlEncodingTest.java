...
public final class UrlEncodingTest extends TestCase {
  ...
  // TODO: b/377734324 - Fix test
  /**
   * Android's URLEncoder.encode() failed for surrogate pairs, encoding them as two replacement
   * characters ("??"). http://b/3436051
   */
  public void ignore_testUrlEncoderEncodesNonPrintableNonAsciiCharacters() throws Exception {
  ...
  // TODO: b/377734324 - Fix test
  public void ignore_testUriEncodesControlCharacters() throws Exception {
  ...
  public void testEncodeAndDecode() throws Exception {
    assertRoundTrip(
        "http://jcltest.apache.org/test?hl=en&q=te st",
    ...
    assertRoundTrip(
        "jar:file://a.jar !/b.c/\u1052", "jar%3Afile%3A%2F%2Fa.jar+%21%2Fb.c%2F%E1%81%92");
    assertRoundTrip(
        "ftp://test:pwd@localhost:2121/%D0%9C",
        "ftp%3A%2F%2Ftest%3Apwd%40localhost%3A2121%2F%25D0%259C");
  }

  /** Asserts that {@code original} decodes to {@code decoded} using both URI and UrlDecoder. */
  ...
  /** Asserts that {@code original} encodes to {@code encoded} using both URI and URLEncoder. */
