...
public class InflaterTest extends TestCase {
  ...
  public void testPresetCustomDictionary() throws Exception {
    assertRoundTrip("dictionary".getBytes(UTF_8));
  }

  private static void assertRoundTrip(byte @Nullable [] dictionary) throws Exception {
    ...
    assertEquals(expected, new String(inflatedBytes.toByteArray(), UTF_8));
  }
  ...
  private static byte[] deflate(byte[] input, byte @Nullable [] dictionary) {
