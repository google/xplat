...
/**
 * A {@code URISyntaxException} will be thrown if some information could not be parsed while
 * creating a URI.
 */
@NullMarked
public class URISyntaxException extends Exception {
   ...
   *
   * @param input the string that caused the exception.
   * @param reason the reason why the exception occurred.
   * @param index the position where the exception occurred.
   * @throws NullPointerException if one of the arguments {@code input} or {@code reason} is {@code
   *     null}.
  ...
  /**
   * Constructs a new {@code URISyntaxException} instance containing the string that caused the
   * exception and a description of the problem.
   *
   * @param input the string that caused the exception.
   * @param reason the reason why the exception occurred.
   * @throws NullPointerException if one of the arguments {@code input} or {@code reason} is {@code
  ...
  /**
   * Gets the index at which the syntax error was found or {@code -1} if the index is
   * unknown/unavailable.
   *
  ...
  /**
   * Gets a description of the exception, including the reason, the string that caused the syntax
   * error and the position of the syntax error if available.
   *
