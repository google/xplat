...
/**
 * CookiePolicy has three pre-defined policy. They are ACCEPT_ALL, ACCEPT_NONE and
 * ACCEPT_ORIGINAL_SERVER respectively. They are used to decide which cookies should be accepted and
 * which should not be.
 *
 * <p>See <a href="http://www.ietf.org/rfc/rfc2965.txt">RFC 2965</a> sections 3.3 and 7 for more
 * detail.
 *
 * @since 1.6
 */
...
public interface CookiePolicy {
   ...
   *
   * @param uri the URI to used to determine acceptability
   * @param cookie the HttpCookie to be determined
