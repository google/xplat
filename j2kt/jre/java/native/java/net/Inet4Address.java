...
public final class Inet4Address extends InetAddress {
  ...
  /** @hide */
  private static final InetAddress ANY = new Inet4Address(new byte[] {0, 0, 0, 0}, null);
  ...
  Inet4Address(byte[] ipaddress, @Nullable String hostName) {
  ...
  public boolean isMCLinkLocal() {
    return ((ipaddress[0] & 0xff) == 224)
        && (ipaddress[1] == 0)
        && (ipaddress[2] == 0); // 224.0.0/24
  }
