...
final class UrlUtils {
  ...
  /**
   * Returns the path will relative path segments like ".." and "." resolved. The returned path will
   * not necessarily start with a "/" character. This handles ".." and "." segments at both the
   * beginning and end of the path.
   *
   * @param discardRelativePrefix true to remove leading ".." segments from the path. This is
  ...
  /**
   * Returns a path that can be safely concatenated with {@code authority}. If the authority is null
  ...
  /**
   * Returns the scheme prefix like "http" from the URL spec, or null if the spec doesn't start with
  ...
  /**
   * Returns the index of the first char of {@code chars} in {@code string} bounded between {@code
   * start} and {@code end}. This returns {@code end} if none of the characters exist in the
   * requested range.
   */
