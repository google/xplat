...
class Integer {
  companion object {
    ...
    fun getInteger(string: kotlin.String?): Int? = System.getProperty(string ?: "")?.toIntOrNull()

    fun getInteger(string: kotlin.String?, defaultValue: Int): Int =
      getInteger(string) ?: defaultValue
