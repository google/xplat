...
public class BufferedInputStream extends FilterInputStream {
  ...
  /**
   * Constructs a new {@code BufferedInputStream}, providing {@code in} with a buffer of 8192 bytes.
   *
   * <p><strong>Warning:</strong> passing a null source creates a closed {@code
   * BufferedInputStream}. All read operations on such a stream will fail with an IOException.
   *
   ...
   * can be read before a mark is invalidated. Calling {@code reset()} will reposition the stream
   ...
   * these bytes unless {@code reset} is used.
   *
   * @param byteCount the number of bytes to skip. {@code skip} does nothing and returns 0 if {@code
