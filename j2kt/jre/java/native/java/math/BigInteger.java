...
public class BigInteger extends Number implements Comparable<BigInteger>,
  ...
  /**
   * Returns a new {@code BigInteger} whose value is {@code this^exponent mod m}. The modulus {@code
   * m} must be positive. The result is guaranteed to be in the interval {@code [0, m)} (0
