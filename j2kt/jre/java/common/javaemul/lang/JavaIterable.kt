...
internal inline fun <T> MutableIterable<T>.default_forEach(consumer: Consumer<in T>) {
  forEach(consumer::accept)
}

internal inline fun <T> MutableIterable<T>.default_spliterator(): Spliterator<T> =
