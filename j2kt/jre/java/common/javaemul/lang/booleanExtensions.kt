 ...
 */
operator fun Boolean.Companion.invoke(b: Boolean): Boolean =
  // In Kotlin JVM, java.lang.Boolean(b) is not assignable to kotlin.Boolean without the extra cast.
  JavaBoolean(b) as Boolean
