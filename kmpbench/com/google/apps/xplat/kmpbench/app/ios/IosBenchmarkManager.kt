...
import third_party.java_src.j2objc.jre_emul_jre_core.JavaUtilMapProtocol
...
fun createIosBenchmarkManager(): BenchmarkManager {
  ...
  val iterator =
    (ComGoogleJ2clBenchmarksAllBenchmarks_get_map() as JavaUtilMapProtocol).entrySet().iterator()
